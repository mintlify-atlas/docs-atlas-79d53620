---
title: "Binary Search Trees: Structure and Properties"
...
Reading the output: the root (`50`) is printed in the middle; nodes above it belong to the right subtree, nodes below to the left subtree. The `┌──` connector indicates a right child and `└──` indicates a left child.
